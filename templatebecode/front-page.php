...
<?php get_header(); ?>
    ...
    <section id="bandeau">
        <div class="left-side">
            ...
            <div class="box-left">
                ...
                <h2><?php echo $bandeau["hover-1"]["titre"];?></h2>
                <p><?php echo $bandeau["hover-1"]["texte"];?></p>
            </div>
        </div>
        <div class="right-side">
            ...
            <div class="box-right">
                ...
                <h2><?php echo $bandeau["hover-2"]["titre"];?></h2>
                <p><?php echo $bandeau["hover-2"]["texte"];?></p>
            </div>
        </div>
    </section>
    <section id="intro">
    ...
    <a href="<?php echo $intro["lien_interne"]["url"];?>"><? echo $intro["lien_interne"]["title"]?></a>
